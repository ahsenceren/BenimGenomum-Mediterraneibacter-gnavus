...
rule glimmerhmm_:
    ...
    params:
          ...
          v=50
    output:
        train_dir = "results/Genomics/2_Annotation/1_Structural/glimmerhmm/{assembler}/trainingglimmerhmm",
...
rule V3_busco_geneset:
    ...
    output:
        "output/{type}/V3/HIN_geneset_V3_eukaryota/"
    params:
...
rule busco_transcriptome:
    ...
    output:
        "output/{type}/{assesment}/HIN_trans"
    params:
